...
InSpec profile overlay to validate the secure configuration of Docker CE
against [CIS's](https://www.cisecurity.org/cis-benchmarks/) Docker CE
Benchmark 1.1.0 tailored for [CMS ARS
...
[issue](https://github.cms.gov/ISPG/cms-ars-3.1-moderate-docker-ce-cis-overlay/issues/new).
\#\# License This is licensed under the [Apache
