...
mkdir profiles
cd profiles
git clone https://github.cms.gov/CMSgov/cms-ars-3.1-moderate-docker-ce-cis-overlay.git
...
## Getting Help
To report a bug or feature request, please open an [issue](https://github.cms.gov/CMSgov/cms-ars-3.1-moderate-docker-ce-cis-overlay/issues/new).
## License
